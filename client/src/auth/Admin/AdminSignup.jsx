  ...
  const handleSubmit = (e) => {
    ...
    axios.post("https://ghumophiro.onrender.com/AdminSignup", formData, { withCredentials: true })
      ...
      .catch((err) => {
        ...
        toast.error("Something went wrong. Admin exists.")
      })
  }
  ...
  return (
    <>
      ...
      <div className="w-full bg-gray-400/70 shadow-lg">
        <div className="flex justify-between items-center p-4">
          ...
          <div className="hidden md:flex gap-4">
            ...
            <Link to="/AdminLogin" className="px-3 py-2 border-2 border-white rounded-2xl text-white font-semibold hover:bg-white/20">Owner Login</Link>
          </div>
      ...
      <div className="flex flex-col md:flex-row w-full justify-center items-center pt-6 gap-6">
        ...
        <div className="w-[90%] md:w-[60%] flex flex-col items-center justify-center gap-4">
          <h1 className="text-2xl font-extrabold text-black">Owner Signup Form</h1>
          <form
            className="flex flex-col items-center w-full md:w-[60%] bg-violet-500 gap-5 p-6 rounded shadow-xl shadow-blue-600/50"
            onSubmit={handleSubmit}
          >
            <label className="text-xl font-semibold text-white" htmlFor="name">Name</label>
            <input
